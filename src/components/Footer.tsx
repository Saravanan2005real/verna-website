...
export default function Footer() {
  ...
  return (
    <footer className="bg-primary-dark text-blue-200 pt-24 pb-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-[1200px] mx-auto px-4 sm:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 pb-16 border-b border-primary-light/30">
          ...
          <div className="lg:col-span-4 lg:pr-8">
            ...
            >
              <motion.a 
                whileHover={{ y: -5, scale: 1.1, backgroundColor: "#0077b5", borderColor: "#0077b5" }}
                animate={{ y: [0, -3, 0] }}
              ...
              <motion.a 
                whileHover={{ y: -5, scale: 1.1, backgroundColor: "#25D366", borderColor: "#25D366" }}
                animate={{ y: [0, -3, 0] }}

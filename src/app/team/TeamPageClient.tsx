        ...
        <div className="flex flex-wrap justify-center gap-x-8 gap-y-16">
          {teamMembers.map((member, i) => (
            ...
            >
              ...
              <div className="w-full aspect-square rounded-xl bg-slate-100 mb-6 relative overflow-hidden border border-slate-200 transition-all duration-500 group-hover:-translate-y-1">
                {member.photo ? (
              ...
              <a 
                ...
                className="inline-flex items-center gap-2 text-xs font-bold text-slate-400 social-text-link--linkedin transition-colors mt-auto"
